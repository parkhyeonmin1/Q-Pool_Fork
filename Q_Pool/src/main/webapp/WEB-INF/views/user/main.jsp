...
<jsp:include page="/WEB-INF/views/common/header.jsp"></jsp:include>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container">
        <h2 data-aos="fade-up" data-aos-delay="100" class="">다양한 문제로<br>쉽게 배우기</h2>
        <p data-aos="fade-up" data-aos-delay="200">뛰어난 강사진이 만든 다양한 문제 풀기</p>
        <div class="d-flex mt-4" data-aos="fade-up" data-aos-delay="300">
          <a href="courses.jsp" class="btn-get-started">문제 풀기</a>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <img src="resources/assets/img/trainers/trainer-2.jpg" class="img-fluid" alt="">
              <div class="member-content">
                <h4>Sarah Jhinson</h4>
                <span>Marketing</span>
                <p>
          ...
          <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <img src="resources/assets/img/trainers/trainer-3.jpg" class="img-fluid" alt="">
              <div class="member-content">
